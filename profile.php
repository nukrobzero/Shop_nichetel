...
if (!isset($_SESSION['user_id'])) { //check session
  ...
  <head>
    ...
    <title>Nichetel Communications | Profile</title>
                    ...
                    //$user_id = htmlspecialchars(isset($_GET['user_id'])?$_GET['user_id']:'');
                      ...
                      <form action="#" method="post">
                        <div class="form-group">
                          ...
                          <br>
                          <br>
                          <a href="./profile_edit.php?user_id=<?php echo $user_id; ?>"><button class="btn btn-primary btn-user btn-block"type="button">
                            แก้ไข
                          </button></a>
                          <hr>                
                        </form>
