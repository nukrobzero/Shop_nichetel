...
<head>
    ...
    <title>Nichetel Communications | Login</title>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="htc__login__register__wrap">
                        ...
                        <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                            <form id="login_form" class="login" action="./process/check_login.php" method="post">
                                <?php 
                                ...
                                <div class="tabs__checkbox">
                                    <span class="forget"><a href="./forgotpassword.php">Forget Pasword?</a></span>
                                </div>
                                <div class="htc__login__btn mt--30">
                                    <button class="btn btn btn-warning" type="submit" style="font-size: 25px;background-color: #ff4136;">Login</button> 
                                </div>
                            </form>
                        </div>
                        <!-- End Single Content -->
                        ...
                        <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade">
                            <form id="register_form" class="login" action="./process/register.php" method="post">
                                ...
                                <div class="htc__login__btn">
                                    <button class="btn btn btn-warning" type="submit" style="font-size: 25px;background-color: #ff4136;">register</button> 
                                </div>
                            </form>
                        </div>
                        <!-- End Single Content -->
