          ...
          <div class="card shadow mb-4" width="800">
            ...
            <div class="card-body">
              <div class="form-group">
                <form action="../process/admins_add.php" method="post">
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <label class="m-0 font-weight-bold text-warning">ชื่อผู้ใช้งาน</label>
                      <input type="text" class="form-control form-control-user" id="exampleInputc_name" placeholder="ชื่อผู้ใช้งาน" name="admin_username" value="" required="">
                    </div>
                    <div class="col-sm-6">
                      <label class="m-0 font-weight-bold text-warning">ชื่อ-นามสกุล</label>
                      <input type="text" class="form-control form-control-user" id="exampleInputc_name" placeholder="ชื่อ-นามสกุล" name="admin_name" value="" required="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="m-0 font-weight-bold text-warning">รหัสผ่าน</label>
                    <input type="password" class="form-control form-control-user" id="exampleInputc_name" placeholder="รหัสผ่าน" name="admin_password" value="" required="">
                  </div> 
                  <div class="form-group">
