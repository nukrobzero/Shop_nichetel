...
<?php
  if (!isset($_SESSION['user_id'])) { //check session
    ...
    <head>
      ...
      <title>Nichetel Communications - Add Stock Products</title>
        ...
        <div class="container pl-1">
          ...
          <div class="card shadow mb-4" width="800">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary">เพิ่มคลังสินค้า</h4>
            </div>
            <div class="card-body">
              <div class="form-group">
                <form action="../process/stock_products_add.php" method="post">
                  <div class="form-group">
                    <label class="m-0 font-weight-bold text-warning">ชื่อคลังสินค้า</label>
                    <input type="text" class="form-control form-control-user" id="exampleInputc_name" placeholder="" name="stock_name" value="" required="">
                  </div>
                  <div class="form-group">
                    <label class="m-0 font-weight-bold text-warning">ที่อยู่</label>
                    <textarea class="form-control form-control-user" id="exampleInputc_name" placeholder="" name="stock_address" value=""></textarea>
                  </div> 
                  <div class="form-group">
                    <label class="m-0 font-weight-bold text-warning">เบอร์โทรศัพท์</label>
                    <input type="number" class="form-control form-control-user" id="exampleInputc_name" placeholder="" name="stock_tel" value="" required="">
                  </div> 
                  <div class="form-group">
                    <label class="m-0 font-weight-bold text-warning">รายละเอียด</label>
                    <textarea class="form-control form-control-user" id="exampleInputc_name" placeholder="" name="stock_detail" value=""></textarea>
                  </div>                
                  <br>
                  <br>
