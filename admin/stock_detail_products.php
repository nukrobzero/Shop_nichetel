...
<head>
  ...
  <title>Nichetel Communications - Products Stock</title>
   ...
   <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h4 class="m-0 font-weight-bold text-primary">สต๊อกสินค้า</h4>
      </div>
      <div class="card-body">
       <?php
          ...
          <tbody>
            ...
            if ($result->num_rows > 0) {
              ...
              while($row = $result->fetch_assoc()) {
                ...
                <td>'.$row["pd_name"].'</td>
                <td>'.$row["pd_balance"].'</td>
                <td>'.$row["pd_book"].'</td>
                <td>'.$row["pd_Ready"].'</td>
                <td style="text-align: center" class="center"><a href="./stock_detail_products_edit.php?pd_id='.$row["pd_id"].'"class="btn btn-success btn-circle"><i class="fas fa-edit center"></i></a>
                </td>
