   ...
   <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h4 class="m-0 font-weight-bold text-primary">รายการเคลมสินค้า</h4>
      </div>
      <div class="card-body">
       <?php
            ...
            if ($result->num_rows > 0) {
              ...
              while($row = $result->fetch_assoc()) {
                ...
                <td class="row">&nbsp;<a href="../process/claim_products_delete.php?claim_id='.$row["claim_id"].'"data-toggle="modal" data-target="#deleteModal'.$row["claim_id"].'" class="btn btn-danger btn-circle" placeholder="ลบ"><i class="fas fa-trash"></i></a>&nbsp;
                  <a href="./claim_products_detail_sw.php?claim_id='.$row["claim_id"].'"class="btn btn-success btn-circle"><i class="fas fa-edit"></i>&nbsp;</a>&nbsp;
                </td>
                </tr>
