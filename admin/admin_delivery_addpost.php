  ...
  <div id="wrapper">
          ...
          <div class="col-lg-10 container">
            <h3>แจ้งการโอนเงิน</h3>
              ...
              $cart_id= ISSET($_GET["cart_id"])?$_GET["cart_id"]:'';
               ?>
          <form class="row contact_form" action="../process/admin_delivery_change_status.php?cart_id=<?php echo $cart_id; ?>" method="post" novalidate="novalidate">
          <div class="order_details_iner">
            <div class="bg-light d-flex justify-content-between mr-4">
              <?php 
              ...
              <h3 class="mr-4">สถานะ :<div class="mr-4" style="color:#000000;background-color:#6DFCED;"> <?php echo $status_bill; ?></div>
      ...
      if ($status == 2 or $status == 3) {
              ...
              <div class="col-md-12 form-group">
                <h3><label class="m-0 font-weight-bold text-warning">หมายเลขพัสดุ</label></h3>
                <input type="text"class="form-control form-control-user" id="examplePreName" placeholder="หมายเลขพัสดุ" name="delivery_number" value="'.$delivery_number.'">
              </div>
      ...
      <a href="./admin_delivery.php"><button class="btn btn-success btn-user btn-block" type="button">
                ย้อนกลับ
              </button></a>
              <br>
              <br>
