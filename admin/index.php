...
<head>
  ...
  <title>Nichetel Communications Admin - Dashboard</title>
      ...
      <?php include "../components/allMenu.php";?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <!-- <a href="./admin_report.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> รายงานยอด</a> -->
          </div>
