...
<?php
  if (!isset($_SESSION['user_id'])) { //check session
    ...
    <head>
      ...
      <title>Nichetel Communications - Add Category</title>
        ...
        <div class="container pl-1">
          ...
          <div class="card shadow mb-4" width="800">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary">เพิ่มประเภทสินค้า</h4>
            </div>
            <div class="card-body">
              <div class="form-group">
                <form action="../process/category_add.php" method="post">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user" id="exampleInputc_name" placeholder="ชื่อประเภทสินค้า" name="cg_name_type" value="" required="">
                  </div>
                  <br>
                  <br>
