          ...
          <div class="card shadow mb-4" width="800">
            ...
            <div class="card-body">
              <div class="form-group">
                  ...
                  ?>
                  <form method="post" action="../process/promotions_edit_img.php?p_id=<?php echo $p_id; ?>" enctype="multipart/form-data">
                    <div class="form-group row">
                      <div class="col-12 mb-3 mb-sm-0 text-center">
                        <img src="../image/uploads/promotions/<?php echo $row["p_img"]; ?>" height="200" ><br>
                        <br>
                  ...
                  <form action="../process/promotions_edit.php?p_id=<?php echo $p_id ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                      <label class="m-0 font-weight-bold text-warning">ชื่อโปรโมชั่น</label>
                      <input type="text" class="form-control form-control-user" id="exampleInputp_title" placeholder="" name="p_name" value="<?php echo $row["p_name"]; ?>" required="">
                    </div>
                      <div class="col-sm-6">
                        <label class="m-0 font-weight-bold text-warning">ลดกี่ %</label>
                        <input type="number" class="form-control form-control-user" id="examplep_percent" placeholder="" name="p_percent" value="<?php echo $row["p_percent"]; ?>" required="">
                      </div> 
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <label class="m-0 font-weight-bold text-warning">เริ่มวันที่</label>
                        <input type="date" class="form-control form-control-user" id="examplep_pre_date" placeholder="" name="p_pre_date" value="<?php echo $row["p_pre_date"]; ?>" required="">
                      </div>
                      <div class="col-sm-6">
                        <label class="m-0 font-weight-bold text-warning">สิ้นสุดวันที่</label>
                        <input type="date" class="form-control form-control-user" id="exampp_pos_date" placeholder="" name="p_pos_date" value="<?php echo $row["p_pos_date"]; ?>" required="">
                      </div>
                    </div>
                    <br>
                    <br>
