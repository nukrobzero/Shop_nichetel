...
if (!isset($_SESSION['user_id'])) { //check session
  ...
  <head>
    ...
    <title>Nichetel Communications | Profile Address Edit</title>
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="bradcaump__inner text-center">
                    <h2 class="bradcaump-title">Profile Address Edit</h2>
                    <nav class="bradcaump-inner">
                      <a class="breadcrumb-item" href="index.php">Home</a>
                      <span class="brd-separetor">/</span>
                      <span class="breadcrumb-item active">Profile Address Edit</span>
                    </nav>
                  </div>
                </div>
              </div>
                 ...
                 <div class="card shadow mb-3">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      $sql ="SELECT * FROM address where ad_id = '$ad_id'";
                      ...
                      ?>
                      <form action="./process/profile_address_edit.php?ad_id=<?php echo $ad_id; ?>" method="post">
                        <div class="form-group">
                          <div class="form-group">
                            <label class="m-0 font-weight-bold text-warning">ชื่อ-นามสกุล</label>
                            <input type="username" class="form-control form-control-user" id="exampleInputusername" placeholder="" name="ad_name" value="<?php echo $row["ad_name"] ?>">
                          </div>
                          <div class="form-group">
                            <label class="m-0 font-weight-bold text-warning">หมายเลขโทรศัพท์</label>
                            <input type="number" class="form-control form-control-user" id="exampleInputEmail" placeholder="" name="ad_tel" value="<?php echo $row["ad_tel"] ?>">
                          </div>
                          <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              <label class="m-0 font-weight-bold text-warning">ตำบล</label>
                              <input type="text" class="form-control form-control-user" id="district" name="ad_district" value="<?php echo $row["ad_district"] ?>">  
                            </div>
                            <div class="col-sm-6">
                              <label class="m-0 font-weight-bold text-warning">อำเภอ</label>
                              <input type="text" class="form-control form-control-user" id="amphoe" name="ad_amphur" value="<?php echo $row["ad_amphur"] ?>">
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              <label class="m-0 font-weight-bold text-warning">จังหวัด</label>
                              <input type="text" class="form-control form-control-user" id="province" name="ad_province" value="<?php echo $row["ad_province"] ?>">
                            </div> 
                            <div class="col-sm-6">
                              <label class="m-0 font-weight-bold text-warning">รหัสไปรษณี</label>
                              <input type="number" class="form-control form-control-user" id="zipcode" name="ad_postcode" value="<?php echo $row["ad_postcode"] ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="m-0 font-weight-bold text-warning">อื่นๆ</label>
                            <input type="text" placeholder="อาคาร , ถนน และอื่่นๆ" class="form-control form-control-user" name="ad_etc" value="<?php echo $row["ad_etc"] ?>">
                          </div> 
                        </div>   
                        <br>
                        <br>
